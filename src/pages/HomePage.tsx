        ...
        <section className="!p-4 w-full overflow-hidden">
            <div className="md:!px-20  flex flex-col md:flex-row items-center  md:justify-between gap-8">
                ...
                <div className="flex flex-col gap-2 md:w-full w-full">
                    ...
                    <h2 className="md:text-[2.9rem] sm:text-[1.8rem] text-2xl font-bold font[var(--font-raleway)]">Where Young Minds Blossom and <span className="text-[var(--secondary-color)]">Dreams Take Flight.</span></h2>
                    ...
                    <div className="flex md:flex-row flex-col md:items-start items-center justify-center gap-8 w-full rounded-lg bg-[var(--quaternary-color)]  shadow-2xl !px-6 !py-4 border-2 border-black">
