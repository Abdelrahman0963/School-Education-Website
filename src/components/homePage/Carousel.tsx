    ...
    return (
        <div className="!mt-8 flex flex-col items-center relative w-full">
            <div className="w-full max-w-6xl relative flex items-center">
                <button
                    onClick={scrollPrev}
                    className="absolute left-0 z-40 cursor-pointer -translate-x-1/2 bg-white border border-black rounded-md !p-2 shadow-md hover:bg-gray-100"
                    aria-label="Previous"
                >
                ...
                <button
                    onClick={scrollNext}
                    className="absolute right-0 z-40 cursor-pointer translate-x-1/2 bg-white border border-black rounded-md !p-2 shadow-md hover:bg-gray-100"
                    aria-label="Next"
                >
